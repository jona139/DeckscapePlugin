...
public final class CardCatalog
{
    ...
    private static volatile List<DeckscapeCard> cards = Collections.unmodifiableList(Arrays.asList(
        ...
        c("wizard_jalarast", "Wizard Jalarast", "Misthalin", COMMON, UNIT, MAGIC, 4, 5, "At the end of your turn, generate an Earth rune. Ability: Give an ally Shield equal to 1 + your Earth runes.", "wizard_jalarast.png"),
        ...
        c("imp", "Imp", "Universal", COMMON, UNIT, MELEE, 4, 2, "Deploy: Damage a random enemy by 2.", "imp.png"),
        c("rick", "Rick", "Misthalin", UNCOMMON, UNIT, MAGIC, 6, 2, "Deploy: Return a chosen allied unit to your hand.", "rick.png"),
        ...
        c("apprentice_felix", "Apprentice Felix", "Misthalin", UNCOMMON, UNIT, MAGIC, 4, 5, "Deploy: If you have at least 2 runes, Bind an enemy.", "apprentice_felix.png"),
        ...
        c("paxton_and_philbert", "Paxton and Philbert", "Misthalin", RARE, UNIT, MELEE, 7, 5, "Deploy: When placed between two Civilians, destroy the weakest enemy unit.", "paxton_and_philbert.png"),
        ...
        c("goblin_mail", "Goblin mail", "Misthalin", COMMON, EQUIPMENT, MAGIC, 5, 0, "Give all allied Goblins +2 power and +2 Strength.", "goblin_mail.png"),
        c("cave_goblin_child", "Cave Goblin Child", "Misthalin", UNCOMMON, UNIT, RANGED, 6, 3, "Action: Deal 2 damage to all enemy Magic units.", "cave_goblin_child.png"),
        ...
        c("juna", "Juna", "Misthalin", EPIC, UNIT, RANGED, 10, 12, "No ability", "juna.png"),
        ...
        c("arthur_the_clue_hunter", "Arthur the Clue Hunter", "Misthalin", COMMON, UNIT, MELEE, 6, 4, "Deploy: Play a Casket.", "arthur_the_clue_hunter.png"),
        c("casket", "Casket", "Universal", UNCOMMON, EQUIPMENT, MAGIC, 7, 0, "Choose one: boost all allies by 2; damage all enemies by 2; or play random faction Equipment.", "casket.png"),
        c("abigaila", "Abigaila", "Misthalin", COMMON, UNIT, MELEE, 5, 4, "Deploy: Look at the top two cards of your deck, play one, and place the other on the bottom.", "abigaila.png"),
        c("oldak", "Oldak", "Misthalin", RARE, UNIT, MAGIC, 7, 5, "Deploy: Play two random Equipment cards from any faction.", "oldak.png"),
        c("thingymajig", "Thingymajig", "Misthalin", UNCOMMON, EQUIPMENT, MAGIC, 5, 0, "Give a Goblin +2 Strength and randomly boost three allies by 1.", "thingymajig.png"),
        c("yew_shortbow", "Yew Shortbow", "Universal", COMMON, EQUIPMENT, RANGED, 4, 0, "Boost all allied Ranged units by 2.", "yew_shortbow.png"),
        c("fire_battlestaff", "Fire battlestaff", "Universal", COMMON, EQUIPMENT, MAGIC, 4, 0, "Boost all allied Magic units by 2.", "fire_battlestaff.png"),
        c("rune_scimitar", "Rune Scimitar", "Universal", COMMON, EQUIPMENT, MELEE, 4, 0, "Boost all allied Melee units by 2.", "rune_scimitar.png"),
        c("rune_kiteshield", "Rune Kiteshield", "Universal", COMMON, EQUIPMENT, MELEE, 4, 0, "Give an allied Melee unit Shield 5.", "rune_kiteshield.png"),
