...
public final class CardCatalog
{
    ...
    private static volatile List<DeckscapeCard> cards = Collections.unmodifiableList(Arrays.asList(
        ...
        c("protect_from_melee", "Protect from Melee", "Universal", COMMON, PRAYER, "protect_from_melee.png"),
        c("protect_from_magic", "Protect from Magic", "Universal", COMMON, PRAYER, "protect_from_magic.png"),
        c("protect_from_ranged", "Protect from Ranged", "Universal", COMMON, PRAYER, "protect_from_ranged.png"),
        c("smite", "Smite", "Universal", COMMON, SPELL, "smite.png"),
